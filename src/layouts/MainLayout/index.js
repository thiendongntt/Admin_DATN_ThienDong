      ...
      >
        <Sider collapsible width={320} className="main__layout-sider">
          <Link to="/" className="main__layout-logo">
            <img src="https://logos.textgiraffe.com/logos/logo-name/Admin-designstyle-smoothie-m.png" alt="logo" />

            {/* <Avatar src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSVMppiB45ueA8QVVD_CO9iucTeC7Ukpw4ZmA&usqp=CAU" /> */}
          </Link>
          <Menu
            theme="dark"
            mode="inline"
